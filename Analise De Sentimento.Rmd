...
extrair_textos_sentimento <- function(url) {
  ...
  if (length(resposta) > 0) {
    ...
    # Extrai, limpa e classifica os textos informativos
    for (texto in textos_informativos) {
      texto_limpo <- limpar_texto(html_text(texto))
      
      # Classifica o sentimento usando sentimentr
      resultado_sentimento <- sentiment_by(texto_limpo)
      sentimento <- resultado_sentimento$sentiment
      intensidade <- resultado_sentimento$ave_sentiment
      
      # Imprime o texto, o sentimento e a intensidade
      print(paste("Texto:", texto_limpo))
      print(paste("Sentimento:", sentimento))
      print(paste("Intensidade:", intensidade))
    }
  } else {
